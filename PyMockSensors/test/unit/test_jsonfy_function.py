...
class TestJsonfy(unittest.TestCase):
    def test_jsonfy(self):
        ...
        expected_json = '{"sensor_name": "Arcella", "sensor_id": "mocked_id", "sensor_type": "temperature", "gather_time": "2024-04-26 12:10:00.123456", "readings": [{"type": "Degrees Celsius", "value":  25.85}], "coordinates": {"type": "point", "coordinates": [45.406434, 11.879008]}}'
