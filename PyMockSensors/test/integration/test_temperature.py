...
class TestTemperature():
    ...
    def setup_producer(self) -> KafkaProducer:
        topic = SensorType.TEMPERATURE.value
    ...
    def after_test(self, setup_clickhouse):
        query = "DELETE FROM sc_database.temperature WHERE sensor_name = 'test';"
    ...
    def test_persistence(self, setup_clickhouse, setup_producer, setup_sensor):
        ...
        while True:
            query = "SELECT sensor_name FROM sc_database.temperature WHERE sensor_name = 'test';"
