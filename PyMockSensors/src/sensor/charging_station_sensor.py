...
class ChargingStationSensor(SensorInterface):
    ...
    def getType(self) -> str:
        return SensorType.CHARGING_STATION
    ...
    def _send_signal(self) -> None:
        ...
        if not self.__is_available:
            if now > (self.__arrival + timedelta(seconds = self.__lay_off)):
                with signal_lock[SensorType.CHARGING_STATION]:
                    signal_list[SensorType.CHARGING_STATION].append(self._sensor_id) 
    ...
    def simulate(self) -> str:
        ...
        return jsonfy(
            ...
            sensor_type=SensorType.CHARGING_STATION,
