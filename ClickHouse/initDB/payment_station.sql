CREATE TABLE sc_database.topic_payment_station
(
    rawJSON String
) ENGINE = Kafka('kafka:9092', 'payment_station', 'SyncCity', 'JSONAsString');

CREATE TABLE sc_database.payment_station
(
    sensor_name String,
    sensor_id String,
...
CREATE MATERIALIZED VIEW sc_database.payment_station_mv
TO sc_database.payment_station
AS
SELECT
...
FROM sc_database.topic_payment_station;
